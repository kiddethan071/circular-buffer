...
size\_t size = buffer.size();

size\_t cap = buffer.capacity();
...
g++ -std=c++11 -o circbuf\_test CircBuf.cpp main.cpp
...
Ethan Kidd - \[GitHub Profile](https://github.com/YOUR\_USERNAME)
